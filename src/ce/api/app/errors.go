...
var (
	...
	ErrInvalidDisplayName      = shttperr.New(http.StatusBadRequest, "The display name can only contain alphanumeric characters, hypens (-) and cannot be empty.", "invalid-display-name")
	ErrDoubleHypenDisplayName  = shttperr.New(http.StatusBadRequest, "Double hypens (--) are not allowed as they are reserved for Stormkit.", "invalid-display-name")
